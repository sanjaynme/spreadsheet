package np.edu.nast.demoapp.androidspreadsheet;
...
public class SampleObject {
    ...
    public SampleObject(String header1, String header2, String header3,
                        ...
                        String header10, String header11, String header12,
                        String header13, String header14, String header15,
                        String header16, String header17, String header18,
                        String header19, String header20, String header21,
                        String header22, String header23, String header24, String header25) {
